...
(function() {
    try {
        ...
        */
        ...
        /**
        * Command plugin to set the CW status of an extension.
        *
        * Use it with _ast\_proxy_ module as follow:
        *
        *     ast_proxy.doCmd({ command: 'cwSet', exten: '214', activate: true }, function (res) {
        *         // some code
        *     });
        *
        *
        ...
        */
        var cwSet = {
            ...
            /**
            * Execute asterisk action to set the CW status.
            * 
            * @method execute
            ...
            */
            execute: function (am, args, cb) {
                try {
                    // action for asterisk
                    if (args.activate) {
                        var act = { Action: 'DBPut', Family: 'CW', Key: args.exten, Val: 'ENABLED' };
                    } else {
                        var act = { Action: 'DBDel', Family: 'CW', Key: args.exten };
                    }
                    
                    // set the action identifier
                    act.ActionID = action.getActionId('cwSet');
        ...
        // public interface
        exports.data      = cwSet.data;
        exports.execute   = cwSet.execute;
        exports.setLogger = cwSet.setLogger;
