/**
* Provides the REST server for the authorization functions.
*
* @module com_authorization_rest
* @main arch_com_authorization_rest
*/

/**
* Provides the REST server.
*
* @class server_com_authorization_rest
*/
var fs      = require('fs');
var restify = require('restify');
var plugins = require('jsplugs')().require('./plugins/com_authorization_rest/plugins_rest');
...
* @final
* @readOnly
* @default [server_com_authorization_rest]
*/
var IDLOG = '[server_com_authorization_rest]';
...
function config(path) {
    ...
    if (json.authorization && json.authorization.port) {
        port = json.authorization.port;
    ...
    if (json.authorization && json.authorization.address) {
        address = json.authorization.address;
