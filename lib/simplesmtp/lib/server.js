...
var RAIServer = require("../../node-rai/lib/rai").RAIServer,
...
SMTPServerConnection.prototype._onCommandMAIL = function(mail){
    ...
    dnslib.resolveMx(domain, (function(err, addresses){
        if(!this.server.options.disableDNSValidation && (err || !addresses || !addresses.length)){
            this.server.emit("senderValidationFailed", email);
...
SMTPServerConnection.prototype._onCommandRCPT = function(mail){
    ...
    dnslib.resolveMx(domain, (function(err, addresses){
        if(!this.server.options.disableDNSValidation && (err || !addresses || !addresses.length)){
            this.server.emit("recipientValidationFailed", email);
