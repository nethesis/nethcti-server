...
(function() {
    try {
        ...
        *
        *     ast_proxy.doCmd({ command: 'cfbVmSet', exten: '214', val: '214' }, function (res) {
        *         // some code
        *     });
        *
        * @class cfbVmSet
            ...
            execute: function (am, args, cb) {
                try {
                    ...
                    if (args.activate) {
                        ...
                        act = { Action: 'DBPut', Family: 'CFB', Key: args.exten, Val: to };

                    } else {
                        act = { Action: 'DBDel', Family: 'CFB', Key: args.exten };
                    }
