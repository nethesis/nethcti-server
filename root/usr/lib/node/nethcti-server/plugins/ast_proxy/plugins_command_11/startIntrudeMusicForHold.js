...
* @final
* @readOnly
* @default [startIntrudeMusicForHold]
*/
var IDLOG = '[startIntrudeMusicForHold]';
...
(function() {
    try {
        ...
        *
        *     ast_proxy.doCmd({ command: 'startIntrudeMusicForHold', endpointId: '220', endpointType: 'extension' }, function (res) {
        *         // some code
        *     });
        *
        *
        * @class startIntrudeMusicForHold
        * @static
        */
        var startIntrudeMusicForHold = {

            /**
            * Execute asterisk action to intrude on hold music on both side of a dialog.
            * 
            * @method execute
            ...
            */
            execute: function (am, args, cb) {
                try {
                    ...
                    act.ActionID = action.getActionId('startIntrudeMusicForHold');
        ...
        // public interface
        exports.data      = startIntrudeMusicForHold.data;
        exports.execute   = startIntrudeMusicForHold.execute;
        exports.setLogger = startIntrudeMusicForHold.setLogger;
