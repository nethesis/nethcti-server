...
Requires: nodejs010-http-parser
...
- emit new event extenHangup to give "busy" info to the client. Nethesis/dev#5003
- add support for custom cid in extension and trunks. Nethesis/dev#5002
