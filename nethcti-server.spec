...
mv root/usr/lib/node/nethcti-server/nethservice_node_modules/* root/usr/lib/node/nethcti-server/node_modules
...
mv root/usr/lib/node/nethcti-server/plugins/com_static_http/static/templates  $RPM_BUILD_ROOT/home/e-smith/nethcti/static/
...
- Bug #3216: login to a queue from cti doesn't allow the pbx to monitor extension state
