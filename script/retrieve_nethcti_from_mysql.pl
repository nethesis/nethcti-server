...
# se esiste custom includo quello, altrimenti uso standard
if (-e "/var/www/html/amp/panel/fop_layout_custom.pl") {
	require "/var/www/html/amp/panel/fop_layout_custom.pl";
} else {
	# structure is - Legend, startpos, stoppos, color1, color2
	@rectangle1 = ("Interni", 1, 45, "1010ff", "099cccc");
	@rectangle2 = ("Code", 46, 82, "ff1010", "a01000");
	@rectangle3 = ("Fasci", 53, 90, "10ff10", "009900");
	@rectangle4 = ("Parcheggio", 49, 72, "ffff10", "cc9933");
	@rectangle5 = ("Conferenze", 45, 68, "006666", "a01000");
	@rectangles = (\@rectangle1,\@rectangle2,\@rectangle3,\@rectangle4,\@rectangle5);
	
	######## BUTTON INFO #########
	$buttonsizex = 166; # 1+244+1 from information in op_style.cfg
	$buttonsizey = 37; # 1+26+1 from information in op_style.cfg
	$numbuttonsx = 6;
	$numbuttonsy = 15;
	...
	$extenpos=styleinfo("Interni");
	$trunkpos=styleinfo("Fasci");
	$parkingpos=styleinfo("Parking lots");
	$confepos=styleinfo("Conferences");
	$queuepos=styleinfo("Code");
}
...
$op_conf = "/etc/asterisk/nethcti.ini";
